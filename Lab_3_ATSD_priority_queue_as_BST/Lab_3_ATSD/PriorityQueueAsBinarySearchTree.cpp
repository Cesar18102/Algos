...
bool PriorityQueueAsBinarySearchTree::search_rec(Item item, TNode *p)
{
	if(p == NULL)
		return NULL;
...
bool PriorityQueueAsBinarySearchTree::search(Item item)
{
	return search_rec(item, root);
}

TNode* PriorityQueueAsBinarySearchTree::addNode_rec(Item item, TNode *p)
{
	if(p == NULL)
...
void PriorityQueueAsBinarySearchTree::addNode(Item item)
{
	root = addNode_rec(item, root);
}

TNode* PriorityQueueAsBinarySearchTree::delete_NodeFound(TNode *p)
{  	
	if(p->left == NULL)	
	{
		TNode* temp = p->right;
...
TNode* PriorityQueueAsBinarySearchTree::deleteNode_rec(Item item, TNode *p)
{	
...
void PriorityQueueAsBinarySearchTree::deleteNode(Item item)
{   	
	if(search(item))
...
Item PriorityQueueAsBinarySearchTree::dequeueMax()
{
	TNode* temp = findMax();
...
TNode* PriorityQueueAsBinarySearchTree::findMax()
{
	return root == NULL? NULL : findMax_rec(root);
}

TNode* PriorityQueueAsBinarySearchTree::findMax_rec(TNode *p)
{
	if(p->right == NULL)
		return p;
